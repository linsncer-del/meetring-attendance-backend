...
reportsRouter.post('/generate/:meetingId', requireRole(['meeting_creator', 'ict_admin']), generate);
// List reports
...
reportsRouter.post('/:id/submit-to-hr', requireRole(['meeting_creator', 'ict_admin']), submitToHR);
// Archive — HR officers and admins
reportsRouter.patch('/:id/archive', requireRole(['hr_officer', 'ict_admin']), archive);
